...
export default function MainTab() {
  ...
  return (
    <div className="p-5 h-full overflow-y-auto">
      ...
      {/* Controls */}
      <div className="flex flex-wrap gap-[60px] items-end mb-[30px]">
        ...
        <div className="flex flex-col gap-1 flex-1 min-w-[160px]">
          <label className="text-[10px] font-medium text-text-secondary uppercase tracking-[.05em]">Velocidad de robots</label>
